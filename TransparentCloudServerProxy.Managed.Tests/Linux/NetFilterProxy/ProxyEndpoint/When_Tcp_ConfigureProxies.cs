...
namespace TransparentCloudServerProxy.Managed.Tests.Linux.NetFilterProxy.ProxyEndpoint {
    public class When_Tcp_ConfigureProxies : Using_NetFilterProxyEndpoint {
        ...
        public void Was_ValidSocketType() {
            _netFilterService.Verify(i => i.RunCommand(It.Is<string>(i => i.Contains("tcp", StringComparison.OrdinalIgnoreCase))), Times.Once());
        }
    }
}
