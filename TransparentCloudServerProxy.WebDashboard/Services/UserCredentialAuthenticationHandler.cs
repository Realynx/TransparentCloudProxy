...
namespace TransparentCloudServerProxy.WebDashboard.Services {
    public class UserCredentialAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions> {
        private readonly CredentialsService _credentialsService;
        private readonly IDbContextFactory<WebDashboardDbContext> _dbContextFactory;

        public UserCredentialAuthenticationHandler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger,
